...
try {
    $room = $client->createRoom('aji',['ahyana1995@gmail.com'],'ahyana1995@gmail.com');
    echo 'SUCCESS CREATE ROOM </br>' . $room->id;
} catch (\Exception $e) {
    var_dump('FAILED create ROOM'. $e->getMessage(). ' '.$e->getCode());
}
